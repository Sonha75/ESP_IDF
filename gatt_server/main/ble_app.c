...
static ble_t ble_server;

static ble_recv_handler_t data_recv_handler=NULL;
...
void example_exec_write_event_env(prepare_type_env_t *prepare_write_env, esp_ble_gatts_cb_param_t *param){
    if (param->exec_write.exec_write_flag == ESP_GATT_PREP_WRITE_EXEC){
        ...
        data_recv_handler(prepare_write_env->prepare_buf, prepare_write_env->prepare_len);
    }else{
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ble_server.gatts_if=gatts_if;  //luu bien gatt_if va param thanh toan cuc de dung tron function send data 
    ...
    case ESP_GATTS_WRITE_EVT: {
        ...
        if (!param->write.is_prep){
            ...
            data_recv_handler(param->write.value, param->write.len);
